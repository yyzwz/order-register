    ...
    <Card>
        ...
        <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left">
            ...
            <FormItem label="科室介绍" prop="about">
                <Input v-model="form.about" clearable style="width:570px" type="textarea" :rows="4" placeholder="请填写该科室的介绍信息"/>
            </FormItem>
            <FormItem label="成立日期" prop="startDate">
                <DatePicker type="date" @on-change="changeStartDate" :placeholder="form.startDate" format="yyyy-MM-dd" clearable style="width:570px"></DatePicker>
            </FormItem>
    ...
    methods: {
        ...
        handleSubmit() {
            this.$refs.form.validate(valid => {
                if (valid) {
                    editHospitalSubject(this.form).then(res => {
